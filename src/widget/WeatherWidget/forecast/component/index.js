...
class WeatherWidgetForecast extends Component {
    ...
    // onChange(e) {
    //     const {getWeatherByCity, getWeatherForecastByCity, getCurrentCityWeather, setCity, units, appid} = this.props;
    //     setCity(e.target.value);
    //
    //     if (e.target.value !== '') {
    //         getWeatherByCity(e.target.value, units, appid);
    //         getWeatherForecastByCity(e.target.value, units, appid);
    //     } else {
